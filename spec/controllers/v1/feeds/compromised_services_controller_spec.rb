...
RSpec.describe  V1::Feeds::CompromisedServicesController , type: :controller do
# pending "add some examples to (or delete) #{__FILE__}"

describe 'GET /v1/feeds/' , :type => :request do


it "should get all compromised Services as token type is restricted" do
  #created demo compromised accounts 10
  FactoryGirl.create_list(:compromised_service, 10)
  #created user
  ...
  get '/v1/feeds/dark-web/compromised-services',  xhr: true,  headers: { 'CONTENT_TYPE' => 'application/json', 'ACCEPT' => 'application/json' , 'Authorization' => "Token token=#{api_token.token_key}" } 
...
it "should get 401 as compromised accounts are restricted and in this token_type is normal" do
   ...
   get '/v1/feeds/dark-web/compromised-services',  xhr: true,  headers: { 'CONTENT_TYPE' => 'application/json', 'ACCEPT' => 'application/json' , 'Authorization' => "Token token=#{token}" } 
   json = JSON.parse(response.body)
